...
public class NewChunks extends Module {
    ...
    private final Setting<Boolean> cfg_use_is_full_chunk = this.sg_general.add(new BoolSetting.Builder().name("full-chunk").description("...").defaultValue(false).build());
    ...
    public NewChunks() {
        super(Nigger.Category, "new-chunks", "Detects completely new chunks using certain traits of them");
    }
